...
> 想用其他模型（Doubao、GLM、Gemini、GPT-5……）？请查看 [配置你的模型](/zh/model-common-config.md)，其中列出了所有受支持的服务商。
...
完整流程与排障请参考 [通过 Chrome 插件快速体验](/zh/quick-experience.md)。
...
* **用于测试**：[集成到 Playwright](/zh/integrate-with-playwright.md)，把 Midscene 接入你现有的测试套件。
* **其他平台**：在 [Android](/zh/platforms/android.md)、[iOS](/zh/platforms/ios.md)、[HarmonyOS](/zh/platforms/harmonyos.md) 或 [桌面端](/zh/platforms/desktop.md) 上开始使用。
* **进一步了解**：用 [模型策略](/zh/model-strategy.md) 提升效果，或在 [API 参考](/zh/reference.md#common) 中查阅所有方法。
