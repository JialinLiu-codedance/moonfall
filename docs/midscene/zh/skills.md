...
[Agent Skills](https://github.com/anthropics/skills) 是一种扩展 AI 编程助手能力的格式。Midscene 提供了 Agent Skills，让 AI 编程工具（如 Claude Code、Cline 等）可以通过 CLI 命令驱动 UI 自动化。
...
支持的模型和配置详情请参考 [模型策略](/zh/model-strategy.md) 和 [常用模型配置](/zh/model-common-config.md)。
