...
Midscene 提供了一些即时操作方法，如 `aiTap` `aiInput` `aiScroll` `aiHover` 等，它们也常用于自动化代码中。你可以在 [API](/zh/reference.md#common) 页面查看。
...
关于如何将 Midscene 文档添加到 AI IDE，请参考 [这篇文章](/zh/llm-txt.md#usage)。
